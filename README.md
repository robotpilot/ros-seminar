...
# 2. 본 자료의 목적
본 자료는 'ROS 로봇 프로그래밍 개정증보판'(루비페이퍼 출판사) 및 터틀봇3, OpenManipulator 기반으로 진행되는 수업, 세미나, 강연, 강의 등의 보조 자료로 사용할 수 있도록 구성된 자료입니다. 01~13번까지의 자료는 'ROS 로봇 프로그래밍 개정증보판' 서적의 각 장에 대응하도록 13개의 파일로 구성되어 있으며 기타 유용한 정보들을 부록으로 담았습니다.
